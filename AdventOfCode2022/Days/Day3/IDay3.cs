...
internal interface IDay3 : IDay
{
    ...
    /// <summary>
    /// As you finish identifying the misplaced items, the Elves come to you with another issue.<br/>
    /// <br/>
    ...
    /// of the Elves will be carrying any other item type.<br/>
    /// <br/>
    ...
    /// that is common between all three Elves in each group.<br/>
    /// <br/>
    ...
    /// rucksacks are the first three lines:<br/>
    /// <br/>
    /// <code>
    /// vJrwpWtwJgWrhcsFMMfFFhFp
    /// jqHRNqRjqzjGDLGLrsFMfFZSrLrFZsSL
    /// PmmdzqPrVvPwwTWBwg
    /// </code>
    /// And the second group's rucksacks are the next three lines:<br/>
    /// <br/>
    /// <code>
    /// wMqvLMZHhHMvwLHjbvcjnnSBnvTQFn
    /// ttgJtRGJQctTZtZT
    ...
    /// this must be their badges. In the second group, their badge item type must be Z.<br/>
    /// <br/>
